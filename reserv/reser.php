	...
	<div class="wrap">
		...
		<h2><font color="blue">Passenger Detail</font></h2>
			...
			<table class="table">
				...
				<tr>
					<td style="border-top:0px;"><A href="http://www.localhost/reserv/reser.php?tno=12009&fromstn=BCT&tostn=ADI&doj=2022-12-15&quota=General&class=SL"><input class="btn btn-info"type="submit" ></A></td>
